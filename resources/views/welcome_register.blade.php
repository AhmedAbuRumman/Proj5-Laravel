                    ...
                    <div class="container">
                        <div class="row text-center">
                            ...
                            <div class="jumbotron" style="margin-top: 20px; background-color: honeydew">
                                ...
                                <p class="lead">
                                <p class="lead">Register as a:</p>
                                <div style="margin-bottom: 50px"></div>
                                    <a class="btn btn-success btn-lg mr-5" style="width: 200px" href="{{ route('recruiter.register') }}" role="button">Recruiter</a>
                                    <a class="btn btn-success btn-lg ml-5" style="width: 200px" href="{{ route('register') }}" role="button">User</a>
                                </p>
                            </div>
                        </div>
                    </div>
