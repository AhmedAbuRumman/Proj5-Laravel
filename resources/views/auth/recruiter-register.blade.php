            ...
            <div class="col-lg-4 mx-auto">
                <div class="osahan-login py-4">
                    <div class="text-center mb-4">
                        <a href="index-2.html"><img src="{{asset('public_theme/images/fav.svg')}}" alt=""></a>
                    ...
                    <form method="POST" action="{{ route('recruiter.register.submit') }}">
                        ...
                        <div class="py-3 d-flex align-item-center">
                            ...
                            @endif
                            <span class="ml-auto"> New to Miver? <a href="{{ route('recruiter.register.submit') }}">Join now</a></span>
                        </div>
                    </form>
                </div>
            </div>
